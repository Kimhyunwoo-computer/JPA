...
import com.example.jpastudy.domain.OrderStatus;
import com.example.jpastudy.domain.item.Book;
...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        assertEquals("주문 수량만큼만 재고가 줄어야한다." , 10 - orderCount , book.getStackQuantity());
   ...
   @Test
    public void 주문취소() throws Exception {
       ...
       assertEquals("주문이 취소된 상품은 그만큼 재고가 증가해야한다." , 10 , item.getStackQuantity());
